...
if [ -z "$DATABASE_URL" ]; then
    echo "[ERROR] DATABASE_URL no está definida. Abortando."
    exit 1
fi

echo "[DEBUG] Conectando a: ${DATABASE_URL:0:50}..."
...
# Iniciar Gunicorn usando el puerto dinámico de Render
PORT=${PORT:-8000}
